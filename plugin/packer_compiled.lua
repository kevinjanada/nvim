...
_G.packer_plugins = {
  ...
  ["java-syntax.vim"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/java-syntax.vim",
    url = "https://github.com/uiiaoo/java-syntax.vim"
  },
  ["mermaid.vim"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/mermaid.vim",
  ...
  ["typescript-vim"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/typescript-vim",
  ...
  ["vim-jsx-typescript"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/vim-jsx-typescript",
    url = "https://github.com/peitalin/vim-jsx-typescript"
  },
  ["vim-solidity"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/vim-solidity",
